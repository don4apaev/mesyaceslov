...
Help = (
    ...
    "и его степень, допустимость венчания, церковные праздники, народное название дня, "
    "приметы и пословицы.\n\n"
    "Ты можешь использовать команды {}, {} и {}, чтобы "
    "получить информацию о прошедшем, текущем и грядущем днях соответстввенно.\n\n"
    "Так же я дважды в сутки осуществляю рассылку с церковными праздниками на текущий день и "
...
Post_help = (
    "Для управлениями запланированными публикациями начни команду с \"{0}\". "
    "Без дополнительных параметров в ответ получишь информацию  публикациях.\n"
    "Для редактирования после \"{0}\" укажи редактируемое значение:\n- \"{1}\" для "
    "часового пояса;\n- \"{2}\" для времении публикации святых на сегодня;\n- \"{3}\" "
    "для времении публикации примет на завтра;\nпосле чего укажи значение:\n- для "
    "часового пояса в пределах от -15 до 9;\n- для времени публикации от 0 до 24 или"
    " другое число или \"-\" для отмены публикации."
)
Post_tz = "Часовой пояс для публикаций - МСК{}"
Post_today = "Публикация святых на сегодня {}"
Post_tomorrow = "Публикация примет на завтра {}"
Post_tz_error = (
...
Post_error = "Ошибка публикации: {}."
Post_success = "Успешно опубликовано."
