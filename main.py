# TODO
# Обновление:
# - таблица с 1 сент, переходные в конце
# - поле переходности праздников + таблица правил перехода праздников
# Поиск именин: поле имени + алгоритм распознования
# Пост картинкой: фазы луны, и .т.д.
# Третий раздел - гражданский
# четвёртый раздел - хозяйственный
# Информация о святом
