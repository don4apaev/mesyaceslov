...
class Days_DB_handler(DB_handler):
    ...
    async def fill_daytable(self):
        ...
        try:
            ...
            # 805-827 - +/- 1 день в зависимости от високосности
            ...
            # 1360 - 1 вскр после/на 1 июня
            # 1361 - 6 вскр после Пасхи
            # 1362 - 6 вскр после Пасхи
            # 1384 - среда по Вознесении
            # 1391 - четверг по Вознесении
            # 1406 - пн после Пятидесятницы
            # 1414 - пн после Пятидесятницы
            # 1415 - пн после Пятидесятницы
            # 1438 - чт после Пятидесятницы
            # 1452 - вс после Пятидесятницы
            # 1453 - вс после Пятидесятницы
            # 1485 - первая пт Апостолького поста
            # 1490 - 8 вскр после Пасхи
            # 1491 - 8 вскр после Пасхи
            # 1504 - 2 вс после Пятидесятницы
            # 1561-1567 - 3 вс после Пятидесятницы
            # 1607 - 4 вс после Пятидесятницы
            # 1608 - вс после 1 июля
            # 1649-1651 - вс после 12 июля
            # 1652 - вс после 10 июля
            # 1768 - ближайшее вс к 29 июля
            # 1812 - вс перед 10 августа
            # 1943 - вс после 19 автуста
            # 1997 - вс перед/на 31 августа
            # 1999 - вс после 28 августа
            # 2036 - вс перед 11 сентября
            # 2076 - вс перед 19 сентября
            # 2077 - вс после 8 сентября
            # 2078 - вс ближайшее к 13 сентября
            # 2139 - вс после 20 сентября
            # 2140 - вс после 16 сентября
            # 2260 - ближайшее вс к 3 октября
